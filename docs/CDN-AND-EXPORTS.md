...
> Every `@getforma/core@2.0.1` below is a real pin against the current release.
...
```html
<script type="module">
  import { createSignal, h, mount } from "https://cdn.jsdelivr.net/npm/@getforma/core@2.0.1/dist/forma.esm.js";
...
unpkg equivalent: `https://unpkg.com/@getforma/core@2.0.1/dist/forma.esm.js`
